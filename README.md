...
現在の同梱データ: **21 カテゴリ / 368 問**（すべて Part 5 形式）。各カテゴリ 8 問以上。
...
現在 368 問。当初の完成形として想定した約 370 問に到達した。反復で答えを
覚えてしまわないための目安である 280 問（1 日 20 問ペースで 2 週間空けられる量）
も十分に超えている。
